...
export function PersonalAnalytics({ communityId }: { communityId: string }) {
  ...
  if (isLoading) {
    return (
      <div className="bg-white border-2 border-black rounded-[24px] shadow-[4px_4px_0px_#0A0A0A] p-6 lg:p-8 animate-pulse text-center">
  ...
  return (
    <div className="bg-white border-2 border-black rounded-[24px] shadow-[4px_4px_0px_#0A0A0A] p-6 lg:p-8">
      ...
      {!hasData ? (
        <div className="text-center py-12 text-gray-500 font-medium border-2 border-dashed border-[#E8E8E0] rounded-xl">
          <Activity className="w-12 h-12 text-[#E8E8E0] mx-auto mb-3" />
        ...
        <div className="space-y-12">
          ...
          <div className="pt-2">
            ...
            <div className="h-64 w-full border-b-2 border-black">
            ...
            <div className="h-64 w-full border-b-2 border-black">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={data?.lineChartData}>
                  <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#E8E8E0" />
