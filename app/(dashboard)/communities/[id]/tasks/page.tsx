  ...
  return (
    <div className="flex flex-col gap-8 w-full max-w-[1280px] mx-auto px-4 md:px-8 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mt-6">
        <h1 className="font-heading text-4xl sm:text-[40px] font-extrabold text-foreground">
          Community Tasks
        </h1>
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-start mt-4">
        ...
        <div className="flex-1 flex flex-col gap-8 min-w-0 transition-all duration-300">
          <Suspense 
            fallback={
              <div className="animate-pulse h-[400px] bg-background rounded-[24px] border-2 border-foreground flex flex-col justify-center items-center gap-4">
                <div className="w-12 h-12 bg-card rounded-full border-2 border-foreground"></div>
                <div className="w-48 h-6 bg-card rounded-md border-2 border-foreground"></div>
              </div>
            }
          >
            <CommunityTasksList
        ...
        <div className="w-full lg:w-auto shrink-0 min-w-0 transition-all duration-300">
          <Suspense 
            fallback={
              <div className="animate-pulse h-[300px] bg-background rounded-[24px] border-2 border-foreground p-6 flex flex-col gap-6 lg:w-[320px] xl:w-[360px]">
                <div className="w-32 h-6 bg-card rounded-md border border-foreground"></div>
                <div className="space-y-4">
                  {[1, 2, 3].map(i => (
                    <div key={i} className="flex gap-4 items-center">
                      <div className="w-10 h-10 bg-card rounded-full border border-foreground shrink-0"></div>
                      <div className="h-4 bg-card rounded-md border border-foreground flex-1"></div>
                    </div>
                  ))}
                </div>
              </div>
