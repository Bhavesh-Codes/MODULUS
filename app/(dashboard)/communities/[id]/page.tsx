...
import { Loader2, Settings, UserMinus, UserPlus, Users, ArrowLeft, Shield, Globe, Lock, User, Clock, Star } from "lucide-react"
      ...
      <div className="relative bg-[#FFFFFF] border-[3px] border-[#0A0A0A] rounded-[2rem] shadow-[8px_8px_0px_#0A0A0A] overflow-hidden">
        ...
        <div className="p-6 md:p-8 flex flex-col md:flex-row gap-6 justify-between items-start">
          ...
          <div className="shrink-0 w-full md:w-auto flex flex-col items-stretch md:items-end gap-3 mt-4 md:mt-0 relative z-20">
            ...
            {isOwner && (
              <button title="Community Settings" className="self-end md:self-auto mt-2 w-12 h-12 rounded-[12px] border-[2px] border-[#0A0A0A] bg-[#FFFFFF] shadow-[3px_3px_0px_#0A0A0A] hover:translate-x-[3px] hover:translate-y-[3px] hover:shadow-none transition-all flex items-center justify-center">
