    ...
    <div className="w-full max-w-[1280px] mx-auto p-4 md:p-8 space-y-8 pb-32">
      ...
      <div className="flex flex-col md:flex-row items-center gap-4">
        <div className="relative flex-1 w-full">
          ...
          <Input 
            ...
            className="pl-12 h-14 border-[3px] border-[#0A0A0A] rounded-[1rem] shadow-[4px_4px_0px_#0A0A0A] font-sans text-[16px] focus-visible:ring-0 focus-visible:shadow-[6px_6px_0px_#0A0A0A] transition-all bg-[#FFFFFF]"
          />
        </div>
        <button
          onClick={() => setIsCreateModalOpen(true)}
          className="shrink-0 h-14 px-6 md:px-8 rounded-[1rem] border-[3px] border-[#0A0A0A] bg-[#FFD600] shadow-[6px_6px_0px_#0A0A0A] font-heading font-bold text-[16px] text-[#0A0A0A] hover:translate-x-[6px] hover:translate-y-[6px] hover:shadow-none transition-all flex items-center gap-2"
        >
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20 space-y-4">
          <div className="w-20 h-20 mx-auto rounded-[24px] border-[3px] border-[#0A0A0A] bg-[#F5F5F0] flex items-center justify-center -rotate-6 shadow-[6px_6px_0px_#0A0A0A]">
            <Search className="w-10 h-10 text-[#0A0A0A]" />
          </div>
          <h2 className="font-heading font-extrabold text-[28px] text-[#0A0A0A] mt-6">No communities found</h2>
          <p className="font-sans text-[16px] text-[#555550]">Try adjusting your search or create a new one.</p>
        </div>
      ) : (
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => { if (!open) handleClose() }}>
      <DialogContent className="bg-[#FFFFFF] border-[3px] border-[#0A0A0A] rounded-[2rem] shadow-[8px_8px_0px_#0A0A0A] max-w-md p-8">
        <DialogHeader>
          <DialogTitle className="font-heading font-extrabold text-[24px] text-[#0A0A0A]">
            Create a Community
          </DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 mt-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-4">
              <label className="flex-1 cursor-pointer relative group">
                ...
                <div className="px-4 py-4 border-[2px] border-[#E8E8E0] rounded-[1rem] peer-checked:border-[#0A0A0A] peer-checked:bg-[#F5F5F0] peer-checked:shadow-[4px_4px_0px_#0A0A0A] transition-all text-center group-hover:border-[#0A0A0A]">
                  <div className="font-heading font-bold text-[16px] text-[#0A0A0A]">Public</div>
                  <div className="font-sans text-[13px] text-[#555550] mt-1">Anyone can join</div>
                </div>
              </label>
              ...
              <label className="flex-1 cursor-pointer relative group">
                ...
                <div className="px-4 py-4 border-[2px] border-[#E8E8E0] rounded-[1rem] peer-checked:border-[#0A0A0A] peer-checked:bg-[#F5F5F0] peer-checked:shadow-[4px_4px_0px_#0A0A0A] transition-all text-center group-hover:border-[#0A0A0A]">
                  <div className="font-heading font-bold text-[16px] text-[#0A0A0A]">Private</div>
                  <div className="font-sans text-[13px] text-[#555550] mt-1">Requires approval</div>
                </div>
              </label>
            </div>
          ...
          <DialogFooter className="pt-6 gap-3 flex-col sm:flex-row">
            <button
              type="button"
              onClick={handleClose}
              className="w-full sm:w-auto px-6 py-3 rounded-[0.875rem] border-[2px] border-[#0A0A0A] bg-[#FFFFFF] shadow-[3px_3px_0px_#0A0A0A] font-heading font-bold text-[15px] text-[#0A0A0A] hover:translate-x-[3px] hover:translate-y-[3px] hover:shadow-none transition-all"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={isCreating}
              className="w-full sm:w-auto px-6 py-3 rounded-[0.875rem] border-[2px] border-[#0A0A0A] bg-[#FFD600] shadow-[4px_4px_0px_#0A0A0A] font-heading font-bold text-[15px] text-[#0A0A0A] hover:translate-x-[4px] hover:translate-y-[4px] hover:shadow-none transition-all disabled:opacity-50 flex items-center justify-center gap-2"
            >
