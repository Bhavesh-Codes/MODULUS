...
export function CommunitySettingsModal({ community, currentUserRole }: CommunitySettingsModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl bg-[#FFFFFF] border-[3px] border-[#0A0A0A] rounded-[2rem] shadow-[8px_8px_0px_#0A0A0A] p-0 overflow-hidden max-h-[85vh] flex flex-col">
        <DialogHeader className="px-6 py-4 border-b-[2px] border-[#0A0A0A] bg-[#F5F5F0] shrink-0">
          <DialogTitle className="font-heading font-extrabold text-[22px] flex items-center gap-2">
            <div className="w-8 h-8 rounded-[8px] bg-[#0A0A0A] flex items-center justify-center">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col min-h-0">
          <div className="px-6 pt-4 shrink-0">
            <TabsList className="grid w-full grid-cols-3 p-1 bg-[#E8E8E0] border-[2px] border-[#0A0A0A] rounded-[1rem]">
              <TabsTrigger 
                value="general"
                className="rounded-[0.75rem] font-bold font-heading data-[state=active]:bg-[#FFFFFF] data-[state=active]:border-[2px] data-[state=active]:border-[#0A0A0A] data-[state=active]:shadow-[2px_2px_0px_#0A0A0A]"
              >
                General
              </TabsTrigger>
              <TabsTrigger 
              ...
              <TabsTrigger 
                value="danger"
                className="rounded-[0.75rem] font-bold font-heading data-[state=active]:bg-[#FF3B30] data-[state=active]:text-[#FFFFFF] data-[state=active]:border-[2px] data-[state=active]:border-[#0A0A0A] data-[state=active]:shadow-[2px_2px_0px_#0A0A0A]"
              >
                Danger Zone
              </TabsTrigger>
            </TabsList>
              ...
              <form onSubmit={handleUpdateDetails} className="space-y-5">
                <div className="space-y-2">
                  ...
                  <Input 
                    ...
                    required
                    className="border-[2px] border-[#0A0A0A] shadow-[3px_3px_0px_#0A0A0A] rounded-[0.75rem] h-12 font-sans font-medium"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea 
                    ...
                    rows={4}
                    className="border-[2px] border-[#0A0A0A] shadow-[3px_3px_0px_#0A0A0A] rounded-[0.75rem] font-sans resize-none"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select value={type} onValueChange={setType}>
                    <SelectTrigger className="border-[2px] border-[#0A0A0A] shadow-[3px_3px_0px_#0A0A0A] rounded-[0.75rem] h-12 font-sans font-medium">
                      <SelectValue placeholder="Select type" />
                    </SelectTrigger>
                    <SelectContent className="border-[2px] border-[#0A0A0A] rounded-[1rem] shadow-[4px_4px_0px_#0A0A0A]">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <Input 
                      ...
                      className="border-[2px] border-[#0A0A0A] shadow-[3px_3px_0px_#0A0A0A] rounded-[0.75rem] h-12 font-sans flex-1"
                    />
                    {/* Placeholder for custom upload connection later */}
                    <div className="w-12 h-12 bg-[#E8E8E0] border-[2px] border-[#0A0A0A] shadow-[3px_3px_0px_#0A0A0A] rounded-[0.75rem] flex items-center justify-center shrink-0 cursor-not-allowed opacity-50" title="Direct upload coming soon">
                       <ImagePlus className="w-5 h-5" />
                    </div>
                  </div>
                  {bannerUrl && (
                     <div className="mt-3 h-24 rounded-[0.75rem] border-[2px] border-[#0A0A0A] overflow-hidden relative">
                ...
                <div className="pt-4 flex justify-end">
                  <Button 
                    ...
                    className="h-12 px-6 rounded-[0.75rem] bg-[#FFD600] text-[#0A0A0A] border-[2px] border-[#0A0A0A] shadow-[3px_3px_0px_#0A0A0A] hover:bg-[#FFD600] hover:translate-x-[3px] hover:translate-y-[3px] hover:shadow-none transition-all font-heading font-bold text-[16px]"
                  >
            ...
            <TabsContent value="members" className="mt-0 h-full flex flex-col">
              {isLoadingMembers ? (
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between border-b-[2px] border-dashed border-[#0A0A0A] pb-3">
                    <h3 className="font-heading font-extrabold text-[16px]">Community Roster</h3>
                    <span className="bg-[#E8E8E0] px-3 py-1 rounded-full text-[12px] font-bold border-[2px] border-[#0A0A0A]">
                  ...
                  <div className="space-y-3">
                    {members.map(member => {
                      ...
                      return (
                        <div key={member.id} className="flex items-center justify-between p-3 rounded-[1rem] border-[2px] border-[#0A0A0A] bg-[#FFFFFF]">
                           <div className="flex items-center gap-3">
                              ...
                              <div>
                                 <div className="font-heading font-bold text-[14px]">
                                     {member.name} 
                                     {isTargetOwner && <span className="ml-2 text-[10px] bg-[#FFD600] px-1.5 py-0.5 rounded-[4px] border-[1px] border-[#0A0A0A] uppercase tracking-wide">Owner</span>}
                                 </div>
                                 <div className="text-[12px] text-[#555550]">
                                     {member.email}
                                 </div>
                              </div>
                           </div>
                           ...
                           {!isTargetOwner && (
                             <div className="flex items-center gap-2">
                               <Select 
                                 ...
                                 disabled={isMutating}
                               >
                                 <SelectTrigger className="w-[110px] h-9 border-[2px] border-[#0A0A0A] shadow-[2px_2px_0px_#0A0A0A] rounded-[0.5rem] font-bold text-[12px] bg-[#FFFFFF]">
                                   <SelectValue />
                                 </SelectTrigger>
                                 <SelectContent className="border-[2px] border-[#0A0A0A] rounded-[0.75rem]">
                               ...
                               <button
                                 ...
                                 disabled={isMutating}
                                 title="Kick Member"
                                 className="w-9 h-9 flex items-center justify-center rounded-[0.5rem] border-[2px] border-[#0A0A0A] bg-[#FF3B30] text-white shadow-[2px_2px_0px_#0A0A0A] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none transition-all disabled:opacity-50"
                               >
               ...
               <div className="p-5 border-[2px] border-[#FF3B30] bg-[#FF3B30]/10 rounded-[1rem] space-y-4">
                  <div className="flex items-start gap-3 text-[#FF3B30]">
                     ...
                     <div>
                        ...
                        <p className="font-sans text-[14px] mt-1 text-[#0A0A0A]">
                  ...
                  <div className="pt-4 border-t-[2px] border-dashed border-[#FF3B30]/50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                     <div>
                         <h5 className="font-bold text-[15px] text-[#0A0A0A]">Delete Community</h5>
                         <p className="text-[13px] text-[#555550]">Permanently remove this community and all its data.</p>
                     </div>
                     <button
                       onClick={handleDeleteCommunity}
                       disabled={isDeleting}
                       className="shrink-0 h-11 px-5 rounded-[0.75rem] bg-[#FF3B30] text-[#FFFFFF] border-[2px] border-[#0A0A0A] shadow-[3px_3px_0px_#0A0A0A] hover:bg-[#FF3B30] hover:translate-x-[3px] hover:translate-y-[3px] hover:shadow-none transition-all font-heading font-bold text-[14px] flex items-center justify-center gap-2"
                     >
